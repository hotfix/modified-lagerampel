...
define('MODULE_TRAFFIC_LIGHTS_TEXT_TITLE', 'CSS Produkt- & Attributlagerampel v1.1 (2023-06-06)');
...
// descriptions
define('MODULE_TRAFFIC_LIGHTS_STATUS_DESC','Modulstatus');
...
define('MODULE_TRAFFIC_LIGHTS_LISTING_LIGHT_DESC','Wie soll die Lagerampel im Produktlisting angezeigt werden?<br><ul><li>light: grafische Lagerampel</li><li>text: Text-Lagerampel mit Lagerbest&auml;nden</li></ul>');
